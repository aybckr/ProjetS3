<%-- 
    Document   : validation
    Created on : 27 janv. 2018, 08:57:12
    Author     : Hajar
--%>
...
.divatt{
    ...
    <body>
        ...
        <header id="home" class="navbar-fixed-top">
                            ...
                            <div class="container-fluid">
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        <li><a href="profile.jsp?email=<%=mail%>&type=client">Accueil</a></li>                                      
                                        <li><a href="commander.jsp?email=<%=mail%>">Commander</a></li>                                  
                                        <li><a href="reserver.jsp?email=<%=mail%>">Reserver Table</a></li>
                                        <li><a href="validation.jsp?email=<%=mail%>">Livraisons</a></li> 
         ...
         <center> <h4>Confirmez votre livraison </h4></br></br>        
...
try{
    ...
    String query = "select * from commande where category='process' and cinclient='"+cin+"'";
    ...
    <%    while(rs.next()){      %>
       <tr>
            ...
            <form method="post" action="validee">
