...
%>
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li><a href="searchcommande.jsp">Commander</a></li>                                  
                                        <li><a href="searchreservation.jsp">Reserver Table</a></li>
                                         <%}%>
                                        <% if(type.equals("gerant")){%>
                                        <li><a href="demandepub.jsp">Demander PUB</a></li><%}%>
                                        <% if(type.equals("livreur")){%>
                                        <li><a href="">Valider commandes</a></li>
                                        <%}%>
                                        <li><a href="#contact">Contactez-nous</a></li>
                                        <li><a href="profile.jsp?email=<%=mail%>">Profil</a></li>
