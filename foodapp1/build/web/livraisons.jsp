...
try{
    ...
    String query = "select * from commande where category='process' and cinlivreur='"+mail+"'";
    ...
    <%    while(rs.next()){      %>
       <tr>
           <form method="post" action="livree">
            ...
            <td hidden=""><input type="number" name="email" value="<%=mail%>"</td>
           ...
           <td><input type="submit" value="Livrée" class="btn btn-primary"> </td>
