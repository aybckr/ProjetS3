...
public class CommandeDaoImpl implements CommandeDAO{
    ...
    try{
        ...
        heritage = initialisationRequetePreparee( connexion, "INSERT INTO commande (cinClient,datecommande) values(?,?)",true,commande.getCinClient(),commande.getDateCommande());
